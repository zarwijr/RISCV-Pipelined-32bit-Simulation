...
* ![Datapath RISC-V](pictures/diagrams/Risc-V_Pipe.png)

## 🛠️ Tools & Technologies
* **Hardware Description Language:** Verilog HDL
* **Architecture:** RISC-V (RV32I Base Integer Instruction Set)
* **Design Type:** 5-Stage Pipelined (IF, ID, EX, MEM, WB)
* **Synthesis & Deployment:** Altera Quartus II v9.0 (32-bit Edition), FPGA Cyclone Series
* **Verification & Simulation:** ModelSim v6.4 (Functional & Timing Simulation)
* **On-board Hardware Debugging:** Manual Stepping & Register Multiplexing
...
*   `./RVPL_TestBench/`: Chứa các kịch bản kiểm thử (Testbench) phục vụ quy trình mô phỏng chức năng hệ thống trên ModelSim v6.4.
